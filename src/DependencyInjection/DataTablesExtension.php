...
namespace Habib\DataTables\DependencyInjection;
...
use Habib\DataTables\Builder\DataTableBuilder;
use Habib\DataTables\Builder\DataTableBuilderInterface;
use Habib\DataTables\Twig\DataTableExtension;
...
class DataTablesExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function prepend(ContainerBuilder $container): void
    {
        ...
        $container->prependExtensionConfig('framework', [
            'asset_mapper' => [
                'paths' => [
                    __DIR__.'/../../assets/dist' => '@habib/datatables',
                ],
            ],
        ]);
    }
